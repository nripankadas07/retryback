        ...
        retryback exists to solve a narrow, inspectable developer-tooling problem:
        ...
        Topics: backoff, decorator, exponential-backoff, jitter, python, resilience, retry, zero-dependencies
